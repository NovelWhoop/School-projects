    ...
    <article>
      <section>
        ...
        <?php
          if(count($_GET))
          {
            if($_GET['Err'] == 1) echo('<div class="alert alert-danger"><span class="glyphicon glyphicon-exclamation-sign"></span>&nbsp;<strong>Chyba!</strong> Špatný login nebo heslo.</div>');
            else echo('<div class="alert alert-danger"><span class="glyphicon glyphicon-exclamation-sign"></span>&nbsp;<strong>Chyba!</strong> Pro přístup na tuto stránku se prosím přihlašte.</div>');
          }
        ?>
